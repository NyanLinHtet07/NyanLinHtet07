        ...
        <div class="  w-full grid mt-20">
            ...
            <div class=" grid grid-cols-1 md:grid-cols-3 gap-4 mx-6 mb-20 mt-10">
               ...
               <div class="px-3 py-2 rounded-lg bg-white/40 hover:shadow-xl fill-neutral-700  text-gray-800 hover:text-rose-900 hover:fill-red-600 transition duration-500">
                    <svg class=" w-48 mx-auto my-5 block drop-shadow-lg" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 70.51">
            ...
            <div class=" my-6">
               ...
               <div class=" grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                <div class=" text-left">
                     ...
                     <div class=" text-left mx-4  font-title font-bold">
                        <h2 class="text-gray-900/90 text-2xl"> OR </h2>
                     </div>

                    <div class=" flex justify-start w-4/5 mb-10 mx-2 mt-5">
                       
                           <p class=" font-semibold font-title mt-2 mr-10 ml-6 text-xs md:text-sm"> You can also </p>
                            <Link :href="route('contact')" class=" text-xs md:text-sm px-3 py-2 font-title font-bold  rounded-full bg-white/60 backdrop-blur-md  text-gray-900/90 shadow-lg hover:shadow-xl hover:bg-white/70 hover:text-rose-600 transition duration-300"> Message Me </Link>
